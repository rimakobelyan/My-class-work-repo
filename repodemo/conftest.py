...
from repodemo.histories_project.POM.pages.home_page import HomePage
from repodemo.histories_project.POM.pages.how_did_christmas_start_page import HowDidChristmasStart
...
def get_driver(request, get_browser):
    ...
    request.cls.how_did_christmas_start_page = HowDidChristmasStart(driver)
